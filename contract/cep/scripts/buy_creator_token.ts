...
async function buy_creator_tokens() {
    ...
    tx.moveCall({
        target: `0xa1d97168a230d9bc36e4fc0c629bc5e9d91f921a31122da887e72c25aa1609d6::contenteconomy::buy_creator_tokens`,
        typeArguments: [CREATOR_TOKEN_TYPE], // The token type you're buying
        arguments: [
            tx.object("0xf628948f87093aab23ce07de04c75de5cf9571a3e1b0a1d7757bd164f485d652"),             // exchange
